...
These must be present in `mods/` alongside `mcsrswap-fabric-mod-1.0.22.jar`:
...
Copy `mcsrswap-velocity-plugin-1.0.22.jar` into `plugins/`.
...
```
mcsrswap-fabric-mod-1.0.22.jar
