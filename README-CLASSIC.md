...
These must be present in `mods/` alongside `mcsrswap-fabric-mod-v1.0.15.jar`:
...
Copy `mcsrswap-velocity-plugin-v1.0.15.jar` into `plugins/`.
...
```
mcsrswap-fabric-mod-v1.0.15.jar
