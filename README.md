...
| File | Where it goes |
|---|---|
| `mcsrswap-fabric-mod-1.0.2.jar` | `mods/` folder of every game server |
| `mcsrswap-velocity-plugin-1.0.2.jar` | `plugins/` folder of the Velocity proxy |
...
These must be present in `mods/` alongside `mcsrswap-fabric-mod-1.0.2.jar`:
...
Copy `mcsrswap-velocity-plugin-1.0.2.jar` into `plugins/`.
