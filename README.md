...
| File | Where it goes |
|---|---|
| `mcsrswap-fabric-mod-1.0.52.jar` | `mods/` folder of every game server |
| `mcsrswap-velocity-plugin-1.0.52.jar` | `plugins/` folder of the Velocity proxy |
...
These must be present in `mods/` alongside `mcsrswap-fabric-mod-1.0.52.jar`:
...
Copy `mcsrswap-velocity-plugin-1.0.52.jar` into `plugins/`.
...
```
mcsrswap-fabric-mod-1.0.52.jar
