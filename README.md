...
| File | Where it goes |
|---|---|
| `mcsrswap-fabric-mod-v1.0.11.jar` | `mods/` folder of every game server |
| `mcsrswap-velocity-plugin-v1.0.11.jar` | `plugins/` folder of the Velocity proxy |
...
These must be present in `mods/` alongside `mcsrswap-fabric-mod-v1.0.11.jar`:
...
Copy `mcsrswap-velocity-plugin-v1.0.11.jar` into `plugins/`.
...
```
mcsrswap-fabric-mod-v1.0.11.jar
